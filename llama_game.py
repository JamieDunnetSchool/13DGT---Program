...
def load_high_score():
    try:
        hi_score_file = open("highsocre.txt", 'r')
    except:
        hi_score_file = open("highsocre.txt", 'w')
...
def reset_game():
    ...
    global score, pass_score, start_time, game_ending
...
while not quit_game:
    ...
    while game_ending == True:
        ...
        screen.fill(blue)
        ground_rect = pygame.Rect(0, 500 - ground_size2, ground_size1, 
                                  ground_size2)
